...
public class ResultReceiverClient {
    ...
    public ResultReceiverClient(WebSocketStompClient stompClient, String userName, String language, String jwtToken, BlockingQueue<Map> transcriptionQueue, BlockingQueue<Map> translationQueue) {
